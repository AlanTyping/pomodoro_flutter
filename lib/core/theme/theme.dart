...
class PomodoroTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xff795e2f),
      onTertiaryContainer: Color(0xffffdaa0),
      error: Color.fromARGB(255, 139, 0, 0),
      onError: Color(0xffffffff),
      errorContainer: Color.fromARGB(255, 190, 0, 0),
      onErrorContainer: Color.fromARGB(255, 255, 173, 173),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffffdaa0),
      onTertiary: Color(0xff795e2f),
      tertiaryContainer: Color(0xff795e2f),
      onTertiaryContainer: Color(0xffffdaa0),
      error: Color.fromARGB(255, 255, 182, 182),
      onError: Color.fromARGB(255, 124, 0, 0),
      errorContainer: Color.fromARGB(255, 190, 0, 0),
      onErrorContainer: Color.fromARGB(255, 255, 173, 173),
